...
public class ViewCard extends JPanel implements Constants {
    ...
    private void loadImages() {
        try {
            backImage = ImageIO.read(new File("resources/uno_back_card.png"));
            skipImage = ImageIO.read(new File("resources/skipCard.png"));
            reverseImage = ImageIO.read(new File("resources/reverseCard.png"));
        } catch (IOException e) {
